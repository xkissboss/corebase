...
namespace common.DapperExtend
{
    public class SqlBuilder
    {
        ...
        public class Template
        {
            ...
            void ResolveSql()
            {
                if (_dataSeq != _builder._seq)
                {
                    ...
                    {
                        string rc = pair.Value.ResolveClauses(p);
                        rawSql = rawSql.Replace("/**" + pair.Key + "**/", rc);
                    }
                    parameters = p;
        ...
        public SqlBuilder Limit(int skipNum, int take, dynamic parameters = null)
        {
            AddClause("limit", $"{skipNum}, {take}", parameters, "  ", "\nLIMIT ", "\n", false);
            return this;
        }
